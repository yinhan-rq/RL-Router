...
class LLMEngineWithKVManager:
    ...
    def _prefill(self, request: GenerationRequest, start_at: float):
        ...
        #TODO: get the reusable KV tokens
        # reserved_kv_tokens = self.memory_planner.get_reusable_kv_tokens(request)
        # input_length = request.input_length - reserved_kv_tokens
